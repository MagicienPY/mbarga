		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					<li class="active"><a href="index.php">Acceulle</a></li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="planning.php">planing</a></li>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<p class="text-center text-muted">NB si vous n'avez pas de compte c'est tres simple, <a href="signup.php">Inscrivez vous </a> Mais si vous en avez <a href="signup.php">Connectez vous </a> . </p>
							<hr>
							...
							<form>
								...
								<div class="row">
									<div class="col-lg-8">
										<b><a href="index.php">je me rappel de mon mote de passe!</a></b>
									</div>
